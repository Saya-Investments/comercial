  ...
  return (
    <Card className="p-6 space-y-6">
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2">
          <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Estados NSV</p>
          {hasNsv
    ...
    <Card className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="p-5">
          ...
          <p className="text-xs text-muted-foreground mt-2">Mensajes entregados exitosamente</p>
        </Card>
        <Card className="p-5">
          <div className="text-sm text-muted-foreground">Tasa de Lectura</div>
          <div className="text-3xl font-bold text-purple-600 mt-1">
          ...
          <p className="text-xs text-muted-foreground mt-2">Mensajes leídos por los destinatarios</p>
        </Card>
        <Card className="p-5">
          <div className="text-sm text-muted-foreground">Tasa de Fallo</div>
          <div className="text-3xl font-bold text-red-600 mt-1">
          ...
          <p className="text-xs text-muted-foreground mt-2">Mensajes que fallaron al enviarse</p>
        </Card>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card className="p-5">
          <div className="text-sm font-semibold text-foreground mb-3">Distribución de Estados</div>
          {distribucion.length === 0 ? (
            <div className="h-[220px] flex items-center justify-center text-sm text-muted-foreground">
              Sin datos
            </div>
