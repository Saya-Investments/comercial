...
**a) Sin gestion en 4 horas:**
- Si el lead lleva 4h o mas sin recibir NINGUNA gestion por parte del call center en el CRM
...
- El valor de horas vive en `HORAS_TIMEOUT` del cron `/api/cron/derivacion-cc`. Se arranco el piloto con 2h y se subio a 4h el 22-Abr para dar mas margen al call center.
